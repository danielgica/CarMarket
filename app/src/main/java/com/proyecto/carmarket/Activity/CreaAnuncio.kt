...
class CreaAnuncio : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fecha.setOnClickListener { mostrarSelectorFecha("Fecha") { fechaTextView.text = it } }
        kilometraje.setOnClickListener { mostrarPopupNumero("Kilometraje") { texto -> kilometrajeTextView.text = "$texto Km" } }
        localidad.setOnClickListener { mostrarPopupTexto("Localidad") { texto -> localidadTextView.text = texto } }
        numeroPlazas.setOnClickListener { mostrarPopupNumero("Número de plazas") { texto -> numeroPlazasTextView.text = texto } }
        potencia.setOnClickListener { mostrarPopupNumero("Potencia") { texto -> potenciaTextView.text = "$texto CV" } }
        tipoCombustible.setOnClickListener { mostrarSelector(listOf("Gasolina", "Diésel", "Eléctrico")) { seleccion -> tipoCombustibleTextView.text = seleccion } }
